  ...
  <section id="hero">
    ...
    <div class="container">
      ...
      <div class=" col-lg-6 py-5 py-lg-0 order-2 order-lg-1" data-aos="fade-right">
        <h1>Your new digital experience with Jasa.ID</h1>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="card-title"><h4>
                  <a href="assets/img/services-1.jpg" data-gall="portfolioGallery" class="venobox" title="App 1"><i class="icofont-plus-circle"></i></a>
                  <a href="portfolio-details.html" title="More Details"><i class="icofont-link"></i></a></h4>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-left">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="card-title"><h4>
                  <a href="assets/img/services-2.jpg" data-gall="portfolioGallery" class="venobox" title="App 1"><i class="icofont-plus-circle"></i></a>
                  <a href="portfolio-details.html" title="More Details"><i class="icofont-link"></i></a></h4>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-right">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="card-title"><h4>
                  <a href="assets/img/services-3.jpg" data-gall="portfolioGallery" class="venobox" title="App 1"><i class="icofont-plus-circle"></i></a>
                  <a href="portfolio-details.html" title="More Details"><i class="icofont-link"></i></a></h4>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-left">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="card-title"><h4>
                  <a href="assets/img/services-4.jpg" data-gall="portfolioGallery" class="venobox" title="App 1"><i class="icofont-plus-circle"></i></a>
                  <a href="portfolio-details.html" title="More Details"><i class="icofont-link"></i></a></h4>
                </div>
              </div>
            </div>
